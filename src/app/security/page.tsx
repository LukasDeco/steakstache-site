...
export default function Security() {
  return (
    <div className="flex flex-col gap-8 pt-4 row-start-2 text-neutral-900 justify-between items-center sm:items-start bg-[radial-gradient(100%_100%_at_50%_80%,#FFDADE_0%,#18AB7C_40%,#090C08_70%)] h-screen w-full min-h-screen px-8 pb-20 sm:px-20 font-[family-name:var(--font-geist-sans)]">
      <AppWrapper>
        <Nav />
